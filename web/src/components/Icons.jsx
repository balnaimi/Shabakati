// SVG Icons Component - Unified icon system for the application
// All icons are 24x24 by default and use currentColor for easy theming
...
export const OnlineIcon = ({ size = 24, className = '' }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const OfflineIcon = ({ size = 24, className = '' }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const WifiOffIcon = ({ size = 24, className = '' }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const EmptyIcon = ({ size = 80, className = '' }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 80 80" 
  ...
  >
    ...
    <circle cx="20" cy="22.5" r="2.5" />
    <circle cx="30" cy="22.5" r="2.5" />
    <circle cx="40" cy="22.5" r="2.5" />
    <path d="M30 50 L40 40 L50 50" />
